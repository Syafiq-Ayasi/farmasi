...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Penambahan Resep Obat</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Penambahan Resep Obat</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<?php 
        ...
        if (isset($_POST['simpan1'])){
          ...
          $_SESSION['tambah_resep'] = "rekam medis ditambahkan";
          $_SESSION['tambah_resep'] = "success";
