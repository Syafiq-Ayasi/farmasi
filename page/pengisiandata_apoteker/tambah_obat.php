          ...
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                    ...
                    <form method="POST">
                    <div>
                        <label for="">No. I Kunjungan -------------- Nomor RM ----------------------- Nama Pasien --------------- </label>
...
<?php 
        ...
        $sql=$koneksi->query("update tb_rekam_medis set diagnosa='$diagnosa', ket='$keterangan', status='Selesai',statusobat='Belum Bayar' where no_rm='$kode'");
