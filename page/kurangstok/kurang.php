 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Tambah Data Stok Obat Keluar</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Tambah Data Stok Obat Keluar</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card card-info">
              ...
              <form method="POST" enctype="multipart/form-data">
                <div class="card-body ">
                        ...
                        <div class="form-line">
                                <select name="ket" class="form-control show-tick" required>
                                <option value="">--Pilih Keterangan Pengeluaran--</option>
                        ...
                        <?php 
                            ...
                            $sql=$koneksi->query("insert into tb_pengeluaran_detail(id,tgl,kd_obat,jumlah,ket) values('','$date','$kode','$jumlah','$keterangan')");
                                if ($sql){
                                    $_SESSION['status'] = "Tambah Data Berhasil";
      $_SESSION['status_code'] = "success";
      echo "<meta http-equiv ='refresh' content='2;url=index.php?page=kurangstok'>";
                                    ?>
