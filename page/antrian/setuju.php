<?php
    ...
    if($statusantrian=='Dalam Antrian'){
        $sql = $koneksi->query("update tb_antrian set status_antrian='Sudah Datang' where user_id='$id' and tanggal_kunjungan='$tgl'");
        $sql = $koneksi->query("update tb_pasien set status='Belum' where nik='$nik_user'");
